...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        //Create every round adter thet - 8 matchups - 4 matchups - 2 matchups - mactchup
        ...
        private static decimal CalculatePrizePayout(this PrizeModel prize, decimal totalIcome)
        {
            decimal output = 0;
            ...
            {
                output = decimal.Multiply(totalIcome, Convert.ToDecimal(prize.PrizePercentage / 100));
            }
